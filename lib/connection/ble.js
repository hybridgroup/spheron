...
module.exports = function(UUID, responseParser) {
	...
	var connectionRituel = function(_connection, callback) {
		devModeOn(function() {
			getCharacteristic(RobotControlService,CommandsCharacteristic,function(err, c) {
				ble._characteristics[UUID][RobotControlService][ResponseCharacteristic].on("read", function(data, isNotify) {
